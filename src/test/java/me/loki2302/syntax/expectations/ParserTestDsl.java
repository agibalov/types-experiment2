...
import me.loki2302.syntax.expectations.element.ElementIsProgramExpectation;
import me.loki2302.syntax.expectations.element.ElementIsStatementExpectation;
import me.loki2302.syntax.expectations.element.expression.ExpressionExpectation;
import me.loki2302.syntax.expectations.element.expression.ExpressionIsBinaryExpressionExpectation;
import me.loki2302.syntax.expectations.element.expression.ExpressionIsExplicitCastExpressionExpectation;
import me.loki2302.syntax.expectations.element.expression.ExpressionIsFunctionCallExpectation;
import me.loki2302.syntax.expectations.element.expression.ExpressionIsLiteralExpressionExpectation;
import me.loki2302.syntax.expectations.element.expression.ExpressionIsUnaryExpressionExpectation;
import me.loki2302.syntax.expectations.element.expression.ExpressionIsVariableReferenceExpectation;
import me.loki2302.syntax.expectations.element.expression.binary.BinaryExpressionExpectation;
import me.loki2302.syntax.expectations.element.expression.binary.BinaryExpressionHasSpecificLeftExpressionExpectation;
import me.loki2302.syntax.expectations.element.expression.binary.BinaryExpressionHasSpecificRightExpressionExpectation;
import me.loki2302.syntax.expectations.element.expression.binary.BinaryExpressionHasSpecificTypeExpectation;
import me.loki2302.syntax.expectations.element.expression.cast.ExplicitCastExpressionExpectation;
import me.loki2302.syntax.expectations.element.expression.cast.ExplicitCastExpressionHasInnerExpressionExpectation;
import me.loki2302.syntax.expectations.element.expression.cast.ExplicitCastExpressionHasTypeReferenceExpectation;
import me.loki2302.syntax.expectations.element.expression.functioncall.FunctionCallExpressionExpectation;
import me.loki2302.syntax.expectations.element.expression.functioncall.FunctionCallHasArgument;
import me.loki2302.syntax.expectations.element.expression.functioncall.FunctionCallHasArgumentsExpectation;
import me.loki2302.syntax.expectations.element.expression.functioncall.FunctionCallIsForSpecificFunctionNameExpectation;
import me.loki2302.syntax.expectations.element.expression.literal.LiteralExpressionExpectation;
import me.loki2302.syntax.expectations.element.expression.literal.LiteralExpressionHasSpecificTypeExpectation;
import me.loki2302.syntax.expectations.element.expression.literal.LiteralExpressionHasSpecificValueExpectation;
import me.loki2302.syntax.expectations.element.expression.unary.UnaryExpressionExpectation;
import me.loki2302.syntax.expectations.element.expression.unary.UnaryExpressionHasSpecificInnerExpressionExpectation;
import me.loki2302.syntax.expectations.element.expression.unary.UnaryExpressionHasSpecificTypeExpectation;
import me.loki2302.syntax.expectations.element.expression.variable.VariableHasSpecificNameExpectation;
...
import me.loki2302.syntax.expectations.element.function.FunctionDefinitionHasBodyExpectation;
import me.loki2302.syntax.expectations.element.function.FunctionDefinitionHasParameterExpectation;
import me.loki2302.syntax.expectations.element.function.FunctionDefinitionHasReturnTypeExpectation;
import me.loki2302.syntax.expectations.element.function.FunctionDefinitionHasSpecificNumberOfParametersExpectation;
import me.loki2302.syntax.expectations.element.function.FunctionDefinitionHasSpeicifcFunctioNameExpectation;
import me.loki2302.syntax.expectations.element.parameter.ParameterDefinitionExpectation;
import me.loki2302.syntax.expectations.element.parameter.ParameterDefinitionHasNameExpectation;
import me.loki2302.syntax.expectations.element.parameter.ParameterDefinitionHasTypeExpectation;
import me.loki2302.syntax.expectations.element.program.ProgramExpectation;
import me.loki2302.syntax.expectations.element.program.ProgramHasFunctionDefinitionExpectation;
import me.loki2302.syntax.expectations.element.program.ProgramHasSpecificNumberOfFunctionsExpectation;
import me.loki2302.syntax.expectations.element.statement.StatementExpectation;
import me.loki2302.syntax.expectations.element.statement.StatementIsBreakStatementExpectation;
import me.loki2302.syntax.expectations.element.statement.StatementIsCompositeStatementExpectation;
import me.loki2302.syntax.expectations.element.statement.StatementIsContinueStatementExpectation;
import me.loki2302.syntax.expectations.element.statement.StatementIsDoWhileStatementExpectation;
import me.loki2302.syntax.expectations.element.statement.StatementIsExpressionStatementExpectation;
import me.loki2302.syntax.expectations.element.statement.StatementIsForStatementExpectation;
import me.loki2302.syntax.expectations.element.statement.StatementIsIfStatementExpectation;
import me.loki2302.syntax.expectations.element.statement.StatementIsNullStatementExpectation;
import me.loki2302.syntax.expectations.element.statement.StatementIsReturnStatementExpectation;
import me.loki2302.syntax.expectations.element.statement.StatementIsVariableDefinitionStatementExpectation;
import me.loki2302.syntax.expectations.element.statement.StatementIsWhileStatementExpectation;
import me.loki2302.syntax.expectations.element.statement.composite.CompositeStatementExpectation;
import me.loki2302.syntax.expectations.element.statement.composite.CompositeStatementHasChildExpectation;
import me.loki2302.syntax.expectations.element.statement.composite.CompositeStatementHasNumberOfChildrenExpectation;
import me.loki2302.syntax.expectations.element.statement.dowhile.DoWhileStatementExpectation;
import me.loki2302.syntax.expectations.element.statement.dowhile.DoWhileStatementHasBodyStatementExpectation;
import me.loki2302.syntax.expectations.element.statement.dowhile.DoWhileStatementHasConditionExpressionExpectation;
import me.loki2302.syntax.expectations.element.statement.expression.ExpressionStatementExpectation;
import me.loki2302.syntax.expectations.element.statement.expression.ExpressionStatementHasSpecificExpressionExpectation;
import me.loki2302.syntax.expectations.element.statement.forstatement.ForStatementExpectation;
import me.loki2302.syntax.expectations.element.statement.forstatement.ForStatementHasBodyStatementExpectation;
import me.loki2302.syntax.expectations.element.statement.forstatement.ForStatementHasConditionExpressionExpectation;
import me.loki2302.syntax.expectations.element.statement.forstatement.ForStatementHasInitializerStatementExpectation;
import me.loki2302.syntax.expectations.element.statement.forstatement.ForStatementHasNoConditionExpressionExpectation;
import me.loki2302.syntax.expectations.element.statement.forstatement.ForStatementHasStepStatementExpectation;
import me.loki2302.syntax.expectations.element.statement.ifstatement.IfStatementDoesNotHaveFalseBranchExpectation;
import me.loki2302.syntax.expectations.element.statement.ifstatement.IfStatementDoesNotHaveTrueBranchExpectation;
import me.loki2302.syntax.expectations.element.statement.ifstatement.IfStatementExpectation;
import me.loki2302.syntax.expectations.element.statement.ifstatement.IfStatementHasConditionExpressionExpectation;
import me.loki2302.syntax.expectations.element.statement.ifstatement.IfStatementHasFalseBranchExpectation;
import me.loki2302.syntax.expectations.element.statement.ifstatement.IfStatementHasTrueBranchExpectation;
import me.loki2302.syntax.expectations.element.statement.returnstatement.ReturnStatementExpectation;
import me.loki2302.syntax.expectations.element.statement.returnstatement.ReturnStatementHasExpressionExpectation;
import me.loki2302.syntax.expectations.element.statement.returnstatement.ReturnStatementHasNoExpressionExpectation;
import me.loki2302.syntax.expectations.element.statement.variabledefinition.VariableDefinitionHasExpressionExpectation;
import me.loki2302.syntax.expectations.element.statement.variabledefinition.VariableDefinitionHasTypeReferenceExpectation;
import me.loki2302.syntax.expectations.element.statement.variabledefinition.VariableDefinitionHasVariableNameExpectation;
...
import me.loki2302.syntax.expectations.element.statement.whilestatement.WhileStatementHasBodyStatementExpectation;
import me.loki2302.syntax.expectations.element.statement.whilestatement.WhileStatementHasConditionExpressionExpectation;
import me.loki2302.syntax.expectations.element.typereference.NamedTypeReferenceExpectation;
import me.loki2302.syntax.expectations.element.typereference.NamedTypeReferenceHasTypeNameExpectation;
import me.loki2302.syntax.expectations.element.typereference.TypeReferenceExpectation;
import me.loki2302.syntax.expectations.element.typereference.TypeReferenceIsNamedTypeExpectation;
import me.loki2302.syntax.expectations.parser.ParseResultExpectation;
import me.loki2302.syntax.expectations.parser.ParseResultIsBadExpectation;
import me.loki2302.syntax.expectations.parser.ParseResultIsOkExpectation;
import me.loki2302.syntax.parser.ExpressionParser;
import me.loki2302.syntax.parser.FunctionDefinitionParser;
import me.loki2302.syntax.parser.ProgramParser;
import me.loki2302.syntax.parser.PureStatementParser;
import me.loki2302.syntax.parser.RootExpressionParser;
import me.loki2302.syntax.parser.StatementParser;
